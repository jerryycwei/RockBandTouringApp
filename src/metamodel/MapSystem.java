...
public class MapSystem
{
  ...
  public Link addLink(Time aTravelTime, Node aOrigin, Node aDestination, double aDistance, TransportationType aTransportType)
  {
    return new Link(aTravelTime, aOrigin, aDestination, aDistance, aTransportType, this);
  }
